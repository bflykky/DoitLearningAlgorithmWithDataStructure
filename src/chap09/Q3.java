...
public class Q3 {
	public static void main(String[] args) {
		LinkedListT<Integer> test = new LinkedListT<>();
...
class LinkedListT<E> {
	...
	public void addLast(E obj) {
		...
		if (head == null)
			...
			if (tail.next == null)
				tail = tail.next = current = new Node<E>(obj, null);
			else
				System.out.println("tail의 next가 null이 아닙니다. 문제가 있습니다.");
		}
	}
